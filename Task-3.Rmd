...
2. Creates a document-feature matrix (converting all tokens into lowercase and removing extra white space).
...
gen.ngrams <- function(text.tokens, num.grams) {
    ...
    dfm.tokens.ngrams <- dfm(tokens.ngrams, tolower = TRUE, remove_padding = TRUE)
